...
import { getMineAllChildren } from "../slices/userSlice";
...
const mineAllChildren =[]
  // Array of objects representing table rows data
  const members = mineAllChildren;
  // const members = [
  //     {
  //         id: 1,
  //         name: 'Harsh Gupta',
  ...
  const filteredMembers = members?.filter(
    (member) =>
      ...
      (currentFilter === "all" ||
        member.user.status.toLowerCase() === currentFilter)
  );
      ...
      <div className="w-full px-0 md:px-6 py-2 ">
        <div className="px-4 md:px-10 py-4 md:py-7 bg-gray-100 rounded-tl-lg rounded-tr-lg bg-black">
          <div className="sm:flex items-center justify-between">
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-[#c3a177]">
              All Users
            </p>
            <div></div>
          </div>
